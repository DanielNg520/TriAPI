...
| File | Status |
|---|---|
| [`docs/carryover/20260829-210000-phase5g7-web-cut-plus-three-triapi-bugs-fixed.md`](docs/carryover/20260829-210000-phase5g7-web-cut-plus-three-triapi-bugs-fixed.md) | **ACTIVE** — oh-my-llama's web chat frontend formally cut (Phase 5G/7 decision executed, ADR 0014, commits `0985257`/`d43812e`/`d5f9284`/`9c84533` there), plus `omll`'s broken async-main entry point found+fixed live; three more real TriAPI pipeline bugs fixed this session (librarian FRESH-verify_cmd trust gap `bdf58a9`, doc-target ceiling wording `16cfd46`, dispatch-summary KeyError `2f635fb`) |
