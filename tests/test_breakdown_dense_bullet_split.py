"""Regression tests for dispatcher._split_phase_by_dense_bullet() /
...
class SplitPhaseByDenseBulletTests(unittest.TestCase):
    def test_no_split_when_bullets_are_similar_size(self) -> None:
        ...
        self.assertIsNone(dispatcher._split_phase_by_dense_bullet(phase_text))
    ...
    def test_splits_off_dominant_bullet(self) -> None:
        ...
        result = dispatcher._split_phase_by_dense_bullet(phase_text)
...
class BreakdownPhaseDenseSplitIntegrationTests(unittest.TestCase):
    ...
    def test_dense_phase_makes_two_calls_and_merges_items(self) -> None:
        ...
        with (
            ...
            mock.patch.object(dispatcher, "_breakdown_phase_attempt", side_effect=fake_attempt) as mock_attempt,
        ):
            result = dispatcher.breakdown_phase(phase_text)
    ...
    def test_rest_failure_short_circuits_before_dense_call(self) -> None:
        ...
        with (
            ...
            result = dispatcher.breakdown_phase(phase_text, max_attempts=1)
