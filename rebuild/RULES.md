...
- The prompt describes required signature/behavior/scope only — never a finished implementation for you to copy. If a prompt already contains what looks like the answer, that's a dispatch error, not a shortcut to take.
