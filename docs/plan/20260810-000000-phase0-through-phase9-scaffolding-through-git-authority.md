# PLAN.md archive — Phase 0 through Phase 9

Moved out of PLAN.md 2026-09-01 to bring it back under the repo's 73,728-char ceiling (PLAN.md had grown to ~205,040 chars). All phases here are marked complete (✅) in the original file; content is reproduced verbatim, nothing summarized or discarded. See PLAN.md's own top-of-file index for the full docs/plan/ split.
